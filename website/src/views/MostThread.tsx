...
const MostThread = defineComponent({
  setup() {
    const options = reactive<RequestOf<typeof api.memberRankController.findThreadRank>>({})

    const { data, isLoading } = useQuery({
      queryKey: ["mostThread"],
      queryFn: () => api.memberRankController.findThreadRank(options),
    })
